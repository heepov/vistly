STRINGS = {
    "en": {
        ...
        "entity_added_to_list": "{entity_title} has been successfully added with {status_type} status",
    ...
    "ru": {
        ...
        "entity_added_to_list": "{entity_title} успешно добавлен в ваш список с статусом {status_type}",
